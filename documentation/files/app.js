...
app.controller('AssignRoleController', function($scope, RestCentralService, $location) {
    ...
    $scope.getStaffAssignment = function(){
        if (!$scope.selectedDate) {
            $("#error").append('<div class="alert alert-danger alert-error"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>Error!</strong> Please enter a date</div>');
            return;
        }
...
app.controller('AllStaffDetailsController', function($scope, RestCentralService, $routeParams) {
    ...
    $scope.getShifts = function(){
        if (!$scope.startDate || !$scope.endDate) {
            $("#error").append('<div class="alert alert-danger alert-error"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>Error!</strong> Please enter both dates</div>');
            return;
        }
